...
import com.yalantis.phoenix.refresh_view.BaseRefreshEventView;
import com.yalantis.phoenix.refresh_view.EventRefreshView;
import com.yalantis.phoenix.util.Utils;
import java.security.InvalidParameterException;

public class PullToRefreshEventView extends ViewGroup {
    ...
    private BaseRefreshEventView mBaseRefreshView;
    ...
    public PullToRefreshEventView(Context context) {
        this(context, null);
    }

    public PullToRefreshEventView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                mBaseRefreshView = new EventRefreshView(getContext(), this);
                break;
            default:
