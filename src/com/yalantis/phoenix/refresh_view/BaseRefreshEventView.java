...
public abstract class BaseRefreshEventView extends Drawable implements Drawable.Callback, Animatable {

    private PullToRefreshEventView mRefreshLayout;
    @SuppressWarnings("unused")
	private boolean mEndOfRefreshing;

    public BaseRefreshEventView(Context context, PullToRefreshEventView parent) {
        mRefreshLayout = parent;
    }
    ...
    public PullToRefreshEventView getRefreshLayout() {
