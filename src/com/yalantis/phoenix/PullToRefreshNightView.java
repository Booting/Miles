...
import com.yalantis.phoenix.refresh_view.BaseRefreshNightView;
import com.yalantis.phoenix.refresh_view.BaseRefreshView;
import com.yalantis.phoenix.refresh_view.NightRefreshView;
import com.yalantis.phoenix.refresh_view.SunRefreshView;
import com.yalantis.phoenix.util.Utils;
import java.security.InvalidParameterException;

public class PullToRefreshNightView extends ViewGroup {
    ...
    private BaseRefreshNightView mBaseRefreshView;
    ...
    public PullToRefreshNightView(Context context) {
        this(context, null);
    }

    public PullToRefreshNightView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_SUN:
                mBaseRefreshView = new NightRefreshView(getContext(), this);
                break;
            default:
